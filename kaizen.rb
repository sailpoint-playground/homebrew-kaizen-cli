class KaizenCli < Formula
  ...
  homepage "https://github.com/sailpoint-playground/homebrew-kaizen-cli"

  url "https://github.com/sailpoint-playground/homebrew--kaizen-cli/archive/refs/tags/v0.1.0.tar.gz"
